...
cp -vf OS/debian12/nyble.hook ${TARGET}/usr/share/initramfs-tools/hooks/nyble
cp -vf OS/debian12/tools.hook ${TARGET}/usr/share/initramfs-tools/hooks/tools
 # insert our modified local script to insure that ROOT=ram doesn't error out
cp -vf OS/debian12/local ${TARGET}/usr/share/initramfs-tools/scripts
...
cp -vf OS/debian12/ramboot.initramfs \
